define("echarts/chart/wordCloud", ["require", "./base", "zrender/shape/Text", "../layout/WordCloud",
    "../component/grid", "../component/dataRange", "../config", "../util/ecData", "zrender/tool/util",
    ...
    var o = e("../config"), r = e("../util/ecData"),
        s = e("zrender/tool/util"), l = e("zrender/tool/color");
    return o.wordCloud = {
        zlevel: 0,
        z: 2,
        clickable: !0,
        ...
        textRotation: [0, 90],
        textPadding: 0,
        autoSize: {enable: !0, minSize: 12, maxSize: 100},
        itemStyle: {
            normal: {
                textStyle: {
                    fontSize: function (e) {
        ...
        type: o.CHART_TYPE_WORDCLOUD, refresh: function (e) {
            ...
            var a = this.series, o = a[t],
                s = o.name || "",
                h = o.data[i], m = [h, o],
                V = this.component.legend,
                d = V ?
                    V.getColor(s) : this.zr.getColor(t),
    ...
    return t.prototype = {
        start: function () {
            function e() {
                p.totalArea = r, d.autoSizeCal.enable && p._autoCalTextSize(m, r, a, o, d.autoSizeCal.minSize, d.autoSizeCal.maxSize), V.timer && clearInterval(V.timer), V.timer = setInterval(t, 0), t()
            }
            ...
            function t() {
                for (var e, t = +new Date, i = m.length; +new Date - t < V.timeInterval && ++s < i && V.timer;)
                    e = m[s],
                        e.x = U[0] >> 1,
                        e.y = U[1] >> 1,
                        p._cloudSprite(e, m, s),
                    e.hasText && p._place(n, e, h) && (l.push(e),
                        e.x -= U[0] >> 1,
                        e.y -= U[1] >> 1);
                s >= i && (p.stop(),
                    p._fixTagPosition(l),
            ...
            var n = null, a = 0, o = 0, r = 0, s = -1, l = [], h = null, m = this.wordsdata,
                V = this.defaultOption,
                d = V.wordletype, U = V.size, p = this,
                c = new i({
                    type: d.type,
                    width: U[0],
                    height: U[1]
            ...
            return e && (this.defaultOption.endcallback = e);
        }, _init: function (e) {
            this.defaultOption = {};
            this._initProperty(e);
            this._initMethod(e);
            this._initCanvas();
            this._initData(e.data);
            ...
            t.size = e.size || [256, 256], t.wordletype = e.wordletype, t.words = e.words || [], t.timeInterval = 1 / 0, t.timer = null, t.spirals = {
                ...
                size: [256, 256],
                wordletype: {type: "RECT", areaPresent: .058, autoSizeCal: {enable: !0, minSize: 12, maxSize: 100}}
            })
            ...
            for (var o, r, s, l = this.defaultOption.size, h = ([{x: 0, y: 0}, {
                    ...
                    y: l[1]
                     ...
                     m = t.y, V = Math.sqrt(l[0] * l[0] + l[1] * l[1]), d = this.defaultOption.spiral(l), U = Math.random() < .5 ? 1 : -1, p = -U; (o = d(p += U)) && (r = ~~o[0], s = ~~o[1], !(Math.min(r, s) > V));)
            ...
            return !1
        }, _autoCalTextSize: function (e, t, i, n, min, max) {
            function o(e) {
                ...
                var  fontSize = e.size <= d || e.rotate && t * r <= e.area && i >= l && n >= h || t * r <= e.area && i >= t && n >= r ? void(e.area = t * r) : (s = e.rotate && l > i && h > n ?
                    Math.min(i / l, n / h) : t > i || r > n ? Math.min(i / t, n / r) : Math.sqrt(e.area / (e.aw * e.ah)), e.size = ~~(s * e.size), e.size < min? void(e.size = min) : o(e), e.size > max ? void(e.size = max) : e.size)
            ...
            for (var s, l, h = r(e, function (e) {
                ...
                return e.size
            }), m = e.length, V = .25, d = min, U = this.defaultOption.cw, p = this.defaultOption.ch, c = this.defaultOption.c, u = this.defaultOption.ratio, g = this.defaultOption.cloudRadians; m--;)s = e[m], l = s.size / h, s.areapre = V ? V > l ? l : V : l, s.area = t * s.areapre, s.totalarea = t, o(s)
        }
    }, t
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            var n, a;
            this._useCustomizedSplit() ? (n = this._splitList[i].max, a = this._splitList[i].min) :
